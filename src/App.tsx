  ...
  desc: (
    <>
      ...
      <section id="overview" className="py-24 px-6">
        ...
        {/* Apply Now Button for Overview */}
        <FadeIn delay={0.2} className="mt-16 flex justify-center">
          <motion.button 
            onClick={() => scrollTo('contact-form')}
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-blue-600 text-white hover:bg-blue-700 px-10 py-5 rounded-full font-black text-xl transition-all shadow-xl shadow-blue-600/25 flex items-center justify-center gap-3 group relative overflow-hidden"
          >
      ...
      <section id="instructors" className="py-24 px-6">
        <FadeIn className="max-w-7xl mx-auto">
          ...
          {/* Apply Now Button for Instructors */}
          <div className="mt-16 flex justify-center">
            <motion.button 
              onClick={() => scrollTo('contact-form')}
              whileHover={{ scale: 1.05 }}
        ...
        <FadeIn className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-2xl">
              ...
              <form action="https://formspree.io/f/mqedvyyq" method="POST" className="space-y-3 md:space-y-4">
